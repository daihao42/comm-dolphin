...
python train_magym.py --scenario traffic_junction --num-agent 10 --log-dir maddpg_ac128_traffic_finalreward_a10g14 --num-episodes 10000 --algorithm maddpg --max-episode-len 500
